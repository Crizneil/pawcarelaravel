                                        ...
                                        <div class="accordion" id="accordionExample">
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                        <p>This system is designed to help veterinary clinics manage pet vaccination records and
                                                            monitor pet health efficiently. It allows quick access to pet information through a simple
                                                            scan while ensuring data privacy.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <p>Each pet is assigned a unique code (such as a QR code). When scanned by authorized
                                                            veterinary staff, the system instantly displays the pet’s vaccination history and health
                                                            records.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseThree" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <p>Yes. The system prioritizes personal privacy. All data is securely stored and can only be
                                                            accessed by authorized users such as veterinarians and clinic staff.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <h3 class="accordion-header" id="headingFour">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        Who can access my pet’s records?
                                                    </button>
                                                </h3>
                                                <div id="collapseFour" class="accordion-collapse collapse"
                                                    aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <p>Only approved veterinary personnel with proper authorization can view or update pet
                                                            records. Pet owners’ information remains protected.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
