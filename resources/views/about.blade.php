...
<body>
    ...
    <div class="page-wrapper">
                            ...
                            <div class="col-lg-3 col-md-2 col-2">
                                <div class="header-right" style="display: flex; align-items: center; gap: 15px;">
                                    ...
                                    <div class="close-form">
                                        <a class="theme-btn" href="login.html">Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <p>PawCare, is a student-developed veterinary system designed to support pet vaccination management
                        ...
                        timely vaccinations and proper health tracking through and organized and digital approach.</p>
                </div>
            </div>
            <div class="shape">
        ...
        <!-- start of we-value-section -->
        <section class="we-value-section section-padding">
            <div class="container">
                ...
                <div class="row justify-content-center g-4">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            <div class="we-value-icon">
                                <i class="ti-user"></i>
                            </div>
                            <h3>Pet Health and Safety</h3>
                            <p>
                                We prioritize preventive care by supporting timely vaccinations and continuous health monitoring to ensure pets live healthy and protected lives.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                We aim to build trust between veterinary clinics and pet owners by providing accurate, organized, and dependable pet health records.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                We value personal privacy and ensure that pet and owner information is kept secure and accessible only to authorized veterinary personnel.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <p>
                                Through a simple scanning system and digital records, we support quick access to pet information, helping veterinarians provide faster and better care.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="we-value-item">
                            ...
                            <h3>Innovation in Veterinary Care</h3>
                            <p>
                                As a student-developed system, PawCare values the use of technology to improve real-world veterinary services and promote responsible pet ownership.
                            </p>
                        </div>
                    </div>
                </div>
